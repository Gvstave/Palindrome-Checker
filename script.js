...
check_btn.addEventListener('click', function(){
    ...
    alert("Please input a value.")
        ...
        result.innerHTML = `${input_value} (${input_reverse}) is a palindrome`
    }
    else{
        result.innerHTML = `${input_value} (${input_reverse}) is not a palindrome`
        setTimeout(()=> {
            alert("Palindrome example: eye, racecar, RacEcar, -e_yE etc")
        }, 400)
    }
